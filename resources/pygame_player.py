...
def function_intercept(intercepted_func, intercepting_func):
    """
    Intercepts a method call and calls the supplied intercepting_func with the result of its call and its arguments
    ...
    value of the intercepted_func as the first argument and its args and kwargs.
